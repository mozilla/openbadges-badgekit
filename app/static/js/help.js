$(document).ready(function() {
  ...
  var faqItems = [
    ...
    },
    {
      ...
      answer : '<p>In general BadgeKit handles the badging processes that do not involve direct interaction with the earner.</p><p>At the moment BadgeKit is primarily aimed at helping organizations to deliver badge issuing. However, the BadgeKit APIs also help you to implement the badging processes not handled within BadgeKit itself. These processes allow you to easily integrate badging within your own environment, in a way that meets the needs of your community. For example, you could provide a custom listing of available badges.</p><p>BadgeKit will be joined by various other badging utilities throughout 2014, including tools for sharing and discovering badges.</p> '
    },
    {
