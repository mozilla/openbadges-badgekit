$(document).ready(function() {
  ...
  var faqItems = [
    ...
    },
    {
      ...
      answer: '<p>We have a hosted version of Mozilla BadgeKit for select partner organizations that meet specific technical requirements. Sign-up for private beta access has now ended, however anyone can download the code from GitHub and implement it on their own servers. </p><p><span class="bold">Software As A Service</span>: With an account at <a href="https://badgekit.org/">BadgeKit.org</a>, you can access a hosted version of the tools to build out badges, remix badge templates, create badge levels, issue badges, etc. APIs make it easy to then pull the badges and end user interfaces into your own website. All of the backend pieces are hosted, supported and updated by Mozilla, and you have complete control over the experience of your end users through your own sites.</p><p><span class="bold">Download</span>: Download the <a href="https://github.com/mozilla/openbadges-badgekit">code</a> and install the tools on your own server. BadgeKit comprises a Web app and an API - see the <a href="https://github.com/mozilla/openbadges-badgekit/wiki/BadgeKit-Self-Hosting-Guide">Self-Hosting Guide</a> for step-by-step instructions to getting both elements set-up in your own environment.</p>'
    },
    {
